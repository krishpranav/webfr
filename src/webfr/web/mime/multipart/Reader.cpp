...
void PartsParser::setPartReader(const webfr::String& partName, const std::shared_ptr<PartReader>& reader) {
...
void AsyncPartsParser::setPartReader(const webfr::String& partName, const std::shared_ptr<AsyncPartReader>& reader) {
  m_readers[partName] = reader;
}
...
void Reader::setPartReader(const webfr::String& partName, const std::shared_ptr<PartReader>& reader) {
...
void AsyncReader::setPartReader(const webfr::String& partName, const std::shared_ptr<AsyncPartReader>& reader) {
  m_partsParser->m_readers[partName] = reader;
}
